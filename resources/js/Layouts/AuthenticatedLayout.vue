    ...
    <div class="main-container">
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                    <NavLink :href="route('admin.leave-requests.index')">
                        <i class="fa fa-list"></i> Liste des demandes
                    </NavLink>
                </li>
                <li>
                    <NavLink :href="route('leave-requests.calendar')" >
                ...
                <li>
                    <NavLink :href="route('reports.generate')">
                        <i class="fa fa-archive"></i> Rapport
                    </NavLink>
                </li>
                <li>
        ...
        <div class="content">
            <slot></slot> <!-- This slot will render dynamic content -->
        </div>
    </div>
</template>
